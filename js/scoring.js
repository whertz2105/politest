...
import { precisionFromBands } from "./precision.js";
// The precision composite (combineRuns) lives in precision.js — meta-analysis across
// runs, distinct from single-run scoring. Re-exported so existing importers of
// scoring.js are unaffected.
export { combineRuns, precisionFromBands, SIGMA_FLOOR, LEGACY_SIGMA } from "./precision.js";
